...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-HG2AU4FP.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-HG2AU4FP.js")).default(client, args);
    case "add":
      return (await import("./add-4IT4GOJW.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-XDPT3CMS.js")).default(client, args);
    case "rm":
      return (await import("./rm-NODZBG52.js")).default(client, args);
    case "update":
      return (await import("./update-BDHCWMWZ.js")).default(client, args);
    default:
